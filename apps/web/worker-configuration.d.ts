/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2eb79ebad445d84965f21b432dd3d438)
// Runtime types generated with workerd@1.20260219.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		STORAGE: R2Bucket;
		DB: D1Database;
		ADMIN_EMAILS: ["s1f102200558@toyo.jp"];
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_EMAILS" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "STORAGE_PUBLIC_URL">> {}
}

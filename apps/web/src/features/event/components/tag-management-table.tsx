...
export function TagManagementTable({
  ...
  const { mutateAsync: reorderMutate } = useMutation(useReorderTagsMutationOption());
  ...
  function handleDragEnd(event: DragEndEvent) {
    ...
    const oldIndex = tagIds.indexOf(cast<TagId>(active.id.toString()));
    const newIndex = tagIds.indexOf(cast<TagId>(over.id.toString()));

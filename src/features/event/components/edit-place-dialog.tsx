...
import { updatePlaceInputSchema, useUpdatePlaceMutation } from "@/features/event/actions/mutations";
...
/**
 * Edit place dialog with Trigger pattern
 */
export function EditPlaceDialog({ eventId, place, children }: EditPlaceDialogProps) {
  return (
    <Dialog.Root size="md">
      ...
      <Portal>
        <Dialog.Backdrop />
        <Dialog.Positioner>
          <EditPlaceDialogContent eventId={eventId} place={place} />
        </Dialog.Positioner>
      </Portal>
    </Dialog.Root>
  );
...
function EditPlaceDialogContent({ eventId, place }: { eventId: EventId; place: PlaceListItem }) {
